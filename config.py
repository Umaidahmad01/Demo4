...
FORCESUB_CHANNEL = int(os.environ.get("FORCESUB_CHANNEL", "-1002189420093"))
FORCESUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1002192610550"))
...
#Force sub message 
FORCE_MSG = os.environ.get("FORCE_SUB_MESSAGE", "OYE {first} NI KAR RAHA CHANNEL JOIN KARO GHUDDHI LAAL\n\n JALDI KAR AIR PIR “𝐍𝐨𝐰 𝐂𝐥𝐢𝐜𝐤 𝐡𝐞𝐫𝐞” PE CLICK KARDE ....!")
